...
#ifdef FEATURE_LED_BUTTON_ON_SAME_PIN
#define BSP_GPIO_PB0_PORT             BUTTON0_LED0_PORT
#define BSP_GPIO_PB0_PIN              BUTTON0_LED0_PIN
#define BSP_GPIO_PB1_PORT             BUTTON1_LED1_PORT
#define BSP_GPIO_PB1_PIN              BUTTON1_LED1_PIN
#define BSP_GPIO_LED0_PORT            BUTTON0_LED0_PORT
#define BSP_GPIO_LED0_PIN             BUTTON0_LED0_PIN
#define BSP_GPIO_LED1_PORT            BUTTON1_LED1_PORT
#define BSP_GPIO_LED1_PIN             BUTTON1_LED1_PIN
#endif /* FEATURE_LED_BUTTON_ON_SAME_PIN */
